     ...
     <div class="qt-valign-wrapper">
      <div class="qt-valign flow-text">
       ...
       <div class="qt-booking-form">
        <ul class="tabs">
               <li class="tab col s4"><h5><a href="#myfiles" class="active">MY FILES</a></h5></li>
               <li class="tab col s4"><h5><a href="#myboards">MY BOARDS</a></h5></li>
               <li class="tab col s4"><h5><a href="#likes">LIKE/SUBSCRIBE</a></h5></li>
           </ul>
<div id="myfiles" class="row qt-contacts"> <!-- tab1 -->
<div id="loader"></div> <!-- loaded file -->
  ...
  <table><tr>
   ...
   <td id="div4" ondrop="drop2(event)" ondragover="allowDrop(event)"></td> 
          ...
          <div id="myboards" class="row qt-contacts"> <!-- tab2 -->
