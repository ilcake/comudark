...
<script type="text/javascript">
	...
	$(function() {
	    ...
	    $("input:checkbox").on('click', function(){
	   	  	if(!this.checked){
		    	$(this).removeAttr("checked");	//checkbox 상태 변환
		    	$("#shared").html("unshared"); //text 변환
	    		...
	    		<form id="form1" runat="server" action="writing" method="post" enctype="multipart/form-data">
		    		...
		    		<br>
						...
						<label class="switch">	<!-- share 체크박스 -->
						  <input type="checkbox" value="true" name="shared" <c:if test="${boardFile.shared == 'true'}">checked</c:if>>
