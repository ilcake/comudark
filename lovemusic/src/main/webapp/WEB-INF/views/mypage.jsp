		...
		<div class="container" style="border: none;">
			<div class="row" style="border: none;">
				<ul class="nav nav-tabs" style="border: none;">
					<li class="active"><a href="#myfiles" data-toggle="tab">MY
							FILES</a></li>
					<li><a data-toggle="tab" href="#myboards">MY BOARDS</a></li>
					<li><a data-toggle="tab" href="#likes">LIKE/SUBSCRIBE</a></li>
				</ul>
				...
				<div class="tab-content" style="margin-top: 1px;">
					...
					<div id="myboards" class="tab-pane fade">
						<!-- =============================== CONTENT ============================= -->
						<div id="container"
							style="margin: 30px; padding: 30px; border: none; position: relative;">
							<!-- 게시물 시작 (Collapse) -->
							<c:forEach var="board" items="${boardList}">
								<div class="s"
									style="border-radius: 10px; background-color: white; padding: 20px; margin: 20px; width: 100%;">
									<table class='board' style="width: 100%;">
										...
										<tr>
											<td colspan="3" style="word-break: break-all;"
												class="content">${fn:replace(board.content, crcn, br)}
												<!-- 글 내용 줄바꿈 처리 --> <br> <c:if
													test="${board.userid == loginId}">
													<!-- 작성ID와 로그인ID가 다를 때만 표시 -->
													<span class="writerButton"
														style="float: right; padding-right: 8px;"> <a
														href=""><span class="glyphicon glyphicon-pencil"
															aria-hidden="true" boardnum="${board.boardnum}"
															style="font-size: small;"></span></a> <!-- 글 수정 버튼 --> <a
														href=""><span class="deleteBoard"
															boardnum="${board.boardnum}">X</span></a> <!-- 글 삭제 버튼 -->
													</span>
												</c:if>
											</td>
										</tr>
									...
									<table class="board" id="col${board.boardnum}">
										<!-- class="collapse" -->
										<!-- 댓글 -->
